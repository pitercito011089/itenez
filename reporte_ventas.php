            ...
            <tbody>
                <?php foreach ($ventas as $venta) { ?>
                    <tr>
                        ...
                        <td>
                            <a href="editar_venta.php?id=<?= $venta->id ?>" class="btn btn-warning">Editar</a>
                            <a href="eliminar_venta.php?id=<?= $venta->id ?>" class="btn btn-danger">Eliminar</a>
                            <form action="recibo_ventas.php" method="post">
                                <input type="hidden" name="idVenta" value="<?= $venta->id ?>">
                                <button type="submit" class="btn btn-info">Recibo</button>
                            </form>
                        </td>
                        <script>
                            function disableButton() {
                            document.getElementById("reciboButton").disabled = true;
                            return true; // Continuar con la acción del formulario
                            }
                        </script>
                    </tr>
                <?php } ?>
